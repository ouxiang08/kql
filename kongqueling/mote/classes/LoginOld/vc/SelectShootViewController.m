...
@interface SelectShootViewController ()

@end

@implementation SelectShootViewController
...
- (void)viewDidLoad
{
    ...
    objrctArr=[[NSArray alloc] initWithObjects:@"时装摄影师",@"广告摄影师",@"人像摄影师",@"风光摄影师", nil];
    for (int i=0; i<4; i++) {
...
-(void)selectTheProm:(id)sender{
    ...
    switch (senbtn.tag) {
        case 50:{
            oneimage.hidden=NO;
            formVC.sheString=[objrctArr objectAtIndex:0];
        ...
        case 51:{
            ...
            twoimage.hidden=NO;
            formVC.sheString=[objrctArr objectAtIndex:1];
        ...
        case 52:{
            ...
            formVC.sheString=[objrctArr objectAtIndex:2];
            
        }
            break;
        case 53:{
            fourimage.hidden=NO;
            formVC.sheString=[objrctArr objectAtIndex:3];
        }
            break;
        default:
            break;
