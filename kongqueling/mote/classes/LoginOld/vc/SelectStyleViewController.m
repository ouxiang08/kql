...
- (void)viewDidLoad
{
    ...
    objrctArr=[[NSArray alloc] initWithObjects:@"化妆师",@"发型师",@"美甲师",@"服装造型师", nil];
    for (int i=0; i<4; i++) {
...
-(void)selectTheProm:(id)sender{
    ...
    switch (senbtn.tag) {
        case 50:{
            oneimage.hidden=NO;
            formVC.zaoString=[objrctArr objectAtIndex:0];
        ...
        case 51:{
            ...
            twoimage.hidden=NO;
            formVC.zaoString=[objrctArr objectAtIndex:1];
        ...
        case 52:{
            ...
            formVC.zaoString=[objrctArr objectAtIndex:2];
            
        }
            break;
        case 53:{
            fourimage.hidden=NO;
            formVC.zaoString=[objrctArr objectAtIndex:3];
        }
            break;
        default:
            break;
