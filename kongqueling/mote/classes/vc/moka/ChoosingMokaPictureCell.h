...
@protocol ChoosingMokaPictureCellDelegate <NSObject>
...
@interface ChoosingMokaPictureCell : UITableViewCell
...
@property(nonatomic, assign) id<ChoosingMokaPictureCellDelegate>delegate;
